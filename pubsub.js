/**
 * 观察者的使用场合就是：当一个对象的改变需要同时改变其它对象，并且它不知道具体有多少对象需要改变的时候，就应该考虑使用观察者模式。 version 1
 */
...
(function(q) {
	...
	q.publish = function(topic, args) {
		...
		setTimeout(
				function() {
					var subscribers = topics[topic], len = subscribers ? subscribers.length
							: 0;
...
/**
 * version 3.如果想让多个对象都具有观察者发布订阅的功能，我们可以定义一个通用的函数，然后将该函数的功能应用到需要观察者功能的对象上，代码如下：
 */
...
/**
 * version 4.根据jQuery1.7版新增的on/off功能，我们也可以定义jQuery版的观察者：
 */
